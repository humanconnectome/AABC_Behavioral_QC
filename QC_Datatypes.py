...
#export temp copy:
rf2full.to_csv("temp3_TLBX_RAW.csv",index=False)
dffull.to_csv("temp3_TLBX_Scores.csv",index=False)
dfreg.to_csv("temp3_TLBX_Registration.csv",index=False)
